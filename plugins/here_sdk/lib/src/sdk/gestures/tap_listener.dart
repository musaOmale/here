...
abstract class TapListener {
  ...
  factory TapListener.fromLambdas(
      ...
      TapListener$Lambdas(lambda_onTap);
...
final _sdk_gestures_TapListener_copy_handle = __lib.catchArgumentError(() =>
    __lib.nativeLibrary.lookupFunction<
        Pointer<Void> Function(Pointer<Void>),
        Pointer<Void> Function(
            Pointer<Void>)>('here_sdk_sdk_gestures_TapListener_copy_handle'));
final _sdk_gestures_TapListener_release_handle = __lib.catchArgumentError(() =>
    __lib.nativeLibrary.lookupFunction<Void Function(Pointer<Void>),
            void Function(Pointer<Void>)>(
        'here_sdk_sdk_gestures_TapListener_release_handle'));
final _sdk_gestures_TapListener_create_proxy = __lib.catchArgumentError(() =>
    __lib.nativeLibrary.lookupFunction<
        Pointer<Void> Function(Uint64, Int32, Pointer, Pointer),
        Pointer<Void> Function(int, int, Pointer,
            Pointer)>('here_sdk_sdk_gestures_TapListener_create_proxy'));
final _sdk_gestures_TapListener_get_raw_pointer = __lib.catchArgumentError(() =>
    __lib.nativeLibrary.lookupFunction<Pointer<Void> Function(Pointer<Void>),
            Pointer<Void> Function(Pointer<Void>)>(
        'here_sdk_sdk_gestures_TapListener_get_raw_pointer'));
final _sdk_gestures_TapListener_get_type_id = __lib.catchArgumentError(() =>
    __lib.nativeLibrary.lookupFunction<
        Pointer<Void> Function(Pointer<Void>),
        Pointer<Void> Function(
            Pointer<Void>)>('here_sdk_sdk_gestures_TapListener_get_type_id'));

class TapListener$Lambdas implements TapListener {
  void Function(Point2D) lambda_onTap;

  TapListener$Lambdas(void Function(Point2D) lambda_onTap) {
  ...
  @override
  onTap(Point2D origin) => lambda_onTap(origin);
}
...
class TapListener$Impl implements TapListener {
  ...
  void release() {
    ...
    __lib.reverseCache
        .remove(_sdk_gestures_TapListener_get_raw_pointer(handle));
...
int _TapListener_onTap_static(int _token, Pointer<Void> origin) {
  try {
    (__lib.instanceCache[_token] as TapListener)
        .onTap(sdk_core_Point2D_fromFfi(origin));
  } finally {
...
Pointer<Void> sdk_gestures_TapListener_toFfi(TapListener value) {
  if (value is TapListener$Impl)
    return _sdk_gestures_TapListener_copy_handle(value.handle);

  final result = _sdk_gestures_TapListener_create_proxy(
      __lib.cacheObject(value),
      __lib.LibraryContext.isolateId,
      __lib.uncacheObjectFfi,
      Pointer.fromFunction<Uint8 Function(Uint64, Pointer<Void>)>(
          _TapListener_onTap_static, __lib.unknownError));
...
Pointer<Void> sdk_gestures_TapListener_toFfi_nullable(TapListener value) =>
    value != null
        ? sdk_gestures_TapListener_toFfi(value)

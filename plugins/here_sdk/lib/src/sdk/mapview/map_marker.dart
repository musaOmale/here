...
abstract class MapMarker {
  ...
  factory MapMarker(GeoCoordinates at, MapImage image) =>
      MapMarker$Impl.$init(at, image);
  ...
  factory MapMarker.withAnchor(
          GeoCoordinates at, MapImage image, Anchor2D anchor) =>
      MapMarker$Impl.withAnchor(at, image, anchor);
...
final _sdk_mapview_MapMarker_copy_handle = __lib.catchArgumentError(() =>
    __lib.nativeLibrary.lookupFunction<
        Pointer<Void> Function(Pointer<Void>),
        Pointer<Void> Function(
            Pointer<Void>)>('here_sdk_sdk_mapview_MapMarker_copy_handle'));
final _sdk_mapview_MapMarker_release_handle = __lib.catchArgumentError(() =>
    __lib.nativeLibrary.lookupFunction<
        Void Function(Pointer<Void>),
        void Function(
            Pointer<Void>)>('here_sdk_sdk_mapview_MapMarker_release_handle'));
final _sdk_mapview_MapMarker_get_raw_pointer = __lib.catchArgumentError(() =>
    __lib.nativeLibrary.lookupFunction<
        Pointer<Void> Function(Pointer<Void>),
        Pointer<Void> Function(
            Pointer<Void>)>('here_sdk_sdk_mapview_MapMarker_get_raw_pointer'));
final __are_equal = __lib.catchArgumentError(() => __lib.nativeLibrary
    .lookupFunction<
        Uint8 Function(Pointer<Void>, Pointer<Void>),
        int Function(Pointer<Void>,
            Pointer<Void>)>('here_sdk_sdk_mapview_MapMarker_are_equal'));
...
class MapMarker$Impl implements MapMarker {
  ...
  MapMarker$Impl.$init(GeoCoordinates at, MapImage image)
      : handle = _$init(at, image) {
    __lib.reverseCache[_sdk_mapview_MapMarker_get_raw_pointer(handle)] = this;
  }

  MapMarker$Impl.withAnchor(GeoCoordinates at, MapImage image, Anchor2D anchor)
      : handle = _withAnchor(at, image, anchor) {
    __lib.reverseCache[_sdk_mapview_MapMarker_get_raw_pointer(handle)] = this;
  }

  static Pointer<Void> _$init(GeoCoordinates at, MapImage image) {
    final _$init_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<
                Pointer<Void> Function(Int32, Pointer<Void>, Pointer<Void>),
                Pointer<Void> Function(int, Pointer<Void>, Pointer<Void>)>(
            'here_sdk_sdk_mapview_MapMarker_make__GeoCoordinates_MapImage'));
    final _at_handle = sdk_core_GeoCoordinates_toFfi(at);
    final _image_handle = sdk_mapview_MapImage_toFfi(image);
    final __result_handle =
        _$init_ffi(__lib.LibraryContext.isolateId, _at_handle, _image_handle);
    sdk_core_GeoCoordinates_releaseFfiHandle(_at_handle);
    sdk_mapview_MapImage_releaseFfiHandle(_image_handle);
    return __result_handle;
  }

  static Pointer<Void> _withAnchor(
      GeoCoordinates at, MapImage image, Anchor2D anchor) {
    final _withAnchor_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<
                Pointer<Void> Function(
                    Int32, Pointer<Void>, Pointer<Void>, Pointer<Void>),
                Pointer<Void> Function(
                    int, Pointer<Void>, Pointer<Void>, Pointer<Void>)>(
            'here_sdk_sdk_mapview_MapMarker_make__GeoCoordinates_MapImage_Anchor2D'));
    final _at_handle = sdk_core_GeoCoordinates_toFfi(at);
    final _image_handle = sdk_mapview_MapImage_toFfi(image);
    final _anchor_handle = sdk_core_Anchor2D_toFfi(anchor);
    final __result_handle = _withAnchor_ffi(__lib.LibraryContext.isolateId,
        _at_handle, _image_handle, _anchor_handle);
    sdk_core_GeoCoordinates_releaseFfiHandle(_at_handle);
    sdk_mapview_MapImage_releaseFfiHandle(_image_handle);
  ...
  @override
  int internalgetId() {
    final _getId_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<
            Int64 Function(Pointer<Void>, Int32),
            int Function(
                Pointer<Void>, int)>('here_sdk_sdk_mapview_MapMarker_getId'));
  ...
  @override
  GeoCoordinates get coordinates {
    final _get_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<
            Pointer<Void> Function(Pointer<Void>, Int32),
            Pointer<Void> Function(Pointer<Void>,
                int)>('here_sdk_sdk_mapview_MapMarker_coordinates_get'));
    final _handle = this.handle;
  ...
  @override
  set coordinates(GeoCoordinates value) {
    final _set_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>),
                void Function(Pointer<Void>, int, Pointer<Void>)>(
            'here_sdk_sdk_mapview_MapMarker_coordinates_set__GeoCoordinates'));
    final _value_handle = sdk_core_GeoCoordinates_toFfi(value);
    final _handle = this.handle;
    final __result_handle =
        _set_ffi(_handle, __lib.LibraryContext.isolateId, _value_handle);
  ...
  Metadata get metadata {
    final _get_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<
            Pointer<Void> Function(Pointer<Void>, Int32),
            Pointer<Void> Function(Pointer<Void>,
                int)>('here_sdk_sdk_mapview_MapMarker_metadata_get'));
    final _handle = this.handle;
    final __result_handle = _get_ffi(_handle, __lib.LibraryContext.isolateId);
    try {
  ...
  set metadata(Metadata value) {
    final _set_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>),
                void Function(Pointer<Void>, int, Pointer<Void>)>(
            'here_sdk_sdk_mapview_MapMarker_metadata_set__Metadata'));
  ...
  int get drawOrder {
    final _get_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<
            ...
            int Function(Pointer<Void>,
                int)>('here_sdk_sdk_mapview_MapMarker_drawOrder_get'));
    final _handle = this.handle;
    final __result_handle = _get_ffi(_handle, __lib.LibraryContext.isolateId);
    try {
      return (__result_handle);
    ...
    final _set_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<
            ...
            void Function(Pointer<Void>, int,
                int)>('here_sdk_sdk_mapview_MapMarker_drawOrder_set__Int'));
  ...
  MapImage get image {
    final _get_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<
            Pointer<Void> Function(Pointer<Void>, Int32),
            Pointer<Void> Function(Pointer<Void>,
                int)>('here_sdk_sdk_mapview_MapMarker_image_get'));
    final _handle = this.handle;
    final __result_handle = _get_ffi(_handle, __lib.LibraryContext.isolateId);
    try {
  ...
  set image(MapImage value) {
    final _set_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>),
                void Function(Pointer<Void>, int, Pointer<Void>)>(
            'here_sdk_sdk_mapview_MapMarker_image_set__MapImage'));
  ...
  Anchor2D get anchor {
    final _get_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<
            Pointer<Void> Function(Pointer<Void>, Int32),
            Pointer<Void> Function(Pointer<Void>,
                int)>('here_sdk_sdk_mapview_MapMarker_anchor_get'));
    final _handle = this.handle;
    final __result_handle = _get_ffi(_handle, __lib.LibraryContext.isolateId);
    try {
  ...
  set anchor(Anchor2D value) {
    final _set_ffi = __lib.catchArgumentError(() => __lib.nativeLibrary
        .lookupFunction<Void Function(Pointer<Void>, Int32, Pointer<Void>),
                void Function(Pointer<Void>, int, Pointer<Void>)>(
            'here_sdk_sdk_mapview_MapMarker_anchor_set__Anchor2D'));
...
Pointer<Void> sdk_mapview_MapMarker_toFfi_nullable(MapMarker value) =>
    value != null
        ? sdk_mapview_MapMarker_toFfi(value)
